...
export const Option7 = ()=>{
    ...
    const [selectMaxDisplay, setSelectMaxDisplay] = useState<number>(1);
    ...
    useEffect(() => {
       updateSelectWidth()
        ...
        document.getElementById("myLovelySelect")?.addEventListener('mouseup', ()=>{
            console.log(">>>>>>>>>>>>>")
            console.log(  document.getElementById("myLovelySelect")?.offsetHeight)
            console.log("<<<<<>>>>>")
        });
