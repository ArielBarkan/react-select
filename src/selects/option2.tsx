        ...
        return (
            <components.ValueContainer {...props}>
                ...
                {( optionsSelectedCount > 0 && (
                    <span id="counter" style={{ marginLeft: "8px", fontSize: "14px", color: "#FFF" , backgroundColor:"#628fbb", borderRadius: "5px" , padding: "5px", width:"20px", justifySelf: "self-end"}} title={generateTitle(optionsSelected)}>
